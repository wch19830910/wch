...
☆【@orz-3的仓库】 https://github.com/Orz-3/mini

☆【@58xinian的仓库】 https://github.com/58xinian/icon

使用方法：
1.选择想要加载的库，根据首页对照表，找到订阅地址。 https://github.com/sngxpro/QuanX （也可在上文的文件列表中，选择想要的仓库文件，点击raw获取真实地址，复制地址即为订阅地址）
